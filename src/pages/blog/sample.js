      ...
      <div className={styles.root}>
        <Container>
          <div className={styles.blogContainer}>
            <Blog
              category={'design'}
              title={'Finest of India: Flora Fricker'}
              image={'/blogFeatured.png'}
              alt={''}
            >
              <div className={styles.content}>
                <p className={styles.excerpt}>
                  Indian-based floral designer Flora Fricker champions seasonal
                  Indian flowers and Indian producers in her beautiful and
              ...
              <div className={styles.content}>
                <h2 className={styles.blogSubHeader}>2. Services</h2>
                <p className={styles.blogParagraph}>
