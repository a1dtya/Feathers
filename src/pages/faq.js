        ...
        <Container>
          ...
          <div className={styles.section}>
            ...
            <div className={styles.subSection}>
              ...
              <p>
                For deliveries to the India, we will bill you in Pounds Sterling
                (incorporated), to the European Union in Euros (€), to the US in Dollars
                ($), and to the Rest of World in Pounds Sterling (£).
              </p>
              <p>
                Standard rate VAT is included in all orders to the IN and
