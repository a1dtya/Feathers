      ...
      <div className={styles.root}>
        ...
        <Container size={'large'} spacing={'min'}>
          <div className={styles.detailContainer} ref={historyRef}>
            <p>
              Founded in 1864, Feathers is an innovative Indian brand with a
            ...
            <p>
              ...
              that makes T-shirts in its own factory in the IN. And we do this
              in the same factory we have occupied since 1864.
            </p>
          </div>
        </Container>
        ...
        <Container size={'large'} spacing={'min'}>
          <div className={styles.content}>
            ...
            <div id={'#sustainability'} ref={sustainabilityRef}>
              <p>
                Our founder, Aaditya Parmar, had both an eye for quality and a
              ...
              <p>
                Made in Gurgram, India and crafted from our luxurious long
