  ...
  return (
    <Layout disablePaddingBottom>
      ...
      <div className={styles.messageContainer}>
        <p>
          This is a Brand for the Wrold by an  {' '}
          <span className={styles.gold}>Indian.</span>
        </p>
        <p>
          WEAR  <span className={styles.gold}>STYLE</span> and{' '}
          <span className={styles.gold}>CONQUER</span>
        </p>
      </div>
      ...
      <div className={styles.socialContainer}>
        <Title
          name={'Style for You'}
          subtitle={'Tag @Feathers to be featured.'}
        />
